...
$consulta = "SELECT idcliente, nombre_client, apellido_client, cedula, tlf_client FROM cliente";
    ...
    <div class="modal-content">
      ...
      <form id="formPersonas">    
            <div class="modal-body">
                ...
                <input type="text" class="form-control" id="nombre_client">
                </div>
                <div class="form-group">
                <label for="apellido_client" class="col-form-label">Apellido:</label>
                <input type="text" class="form-control" id="apellido_client">
                </div>                
                <div class="form-group">
                ...
                <input type="text" class="form-control" id="tlf_client">
                </div>                
            </div>
